...
class TerminalValueResult:
    ...
    weight_perpetuity: float | None = None
    weight_exit_multiple: float | None = None
...
class TerminalValueCalculator:
    ...
    def __init__(self, config: TerminalValueConfig | None = None):
    ...
    def calculate_exit_multiple(
        ...
        peer_multiples: list[float] | None = None,
