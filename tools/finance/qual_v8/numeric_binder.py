...
# 2026-08-22：补全归母净资产/购建固定资产（第6章"归母净资产=59.6"幻觉
# 因 regex 缺该指标而未被 bind_bare_numbers 拦截——与 data_anchor._METRIC_UNITS 对齐）
# 2026-08-26：扩展支持缩写形式（经营现金流/现金流量净额/净利润率等）
_METRIC_NUM_RE = re.compile(
    r"(营业收入|营业利润|归母净利润|归母净资产|经营活动现金流量净额|"
    r"经营活动现金流净额|经营现金流净额|经营活动现金流|经营现金流|"
    r"现金流量净额|现金流净额|"
